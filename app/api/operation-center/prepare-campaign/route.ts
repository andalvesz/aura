import { prepareOperationCampaign } from "@/lib/supabase/services/operation-center.service";
...
export async function POST(request: Request) {
  ...
  const { operation, message, error } = await prepareOperationCampaign(body.operationId);
